...
INSERT INTO "new_Transactions" ("accountId", "amount", "categoryId", "createdAt", "currencyId", "description", "id", "installmentId", "parentTransactionId", "scheduledId", "title", "type", "userId") SELECT "accountId", "amount", "categoryId", "createdAt", "currencyId", "description", "id", "installmentId", "parentTransactionId", "scheduledId", "title", "type", "userId" FROM "Transactions";
