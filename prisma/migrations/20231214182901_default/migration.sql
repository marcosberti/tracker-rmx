/*
  ...
  - You are about to drop the column `main` on the `Account` table. All the data in the column will be lost.
  - Added the required column `default` to the `Account` table without a default value. This is not possible if the table is not empty.
